    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.html"><b><img src="<?php echo base_url();?>assets/images/fts_logo_small_white.png" alt="home" /></b><span class="hidden-xs"><strong>File Tracking</strong></span></a></div>
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="<?php echo base_url();?>" class="waves-effect<?php if($activeMenu == 'PU'):echo ' active';else: echo '';endif;?>"><i class="linea-icon linea-basic fa-fw" data-icon="a"></i> <span class="hide-menu"> Paparan Utama <span class="fa arrow"></span></span></a>
                    </li>
                    <li> <a href="javascript:void(0);" class="waves-effect<?php if($activeMenu == 'FK'):echo ' active';else: echo '';endif;?>"><i class="linea-icon linea-basic fa-fw" data-icon="&#xe00a;"></i> <span class="hide-menu"> Fail Kerja <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li> <a href="<?php echo base_url();?>FailKerja">Tambah</a> </li>
							<?php endif;?>
                        </ul>
                    </li>
                    <li><a href="inbox.html" class="waves-effect<?php if($activeMenu == 'L'):echo ' active';else: echo '';endif;?>"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Laporan <span class="fa arrow"></span></span></a>
                    </li>
                </ul>
            </div>
        </div>
