                        ...
                        <div class="white-box">
                            ...
                            <form class="form" method="post" action="<?php echo base_url();?>FailKerja/tambah">
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input name="NoFail" class="form-control" type="text" value="" id="example-text-input" placeholder="XXXX/X/XX/000-0-0/00-0000" required="" oninvalid="this.setCustomValidity('Sila isi ruangan ini.')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-2 col-form-label">Nama Kerani</label>
                                    <div class="col-10">
                                        <input class="form-control" type="text" value="<?php if($this->session->userdata("LoggedUser")["Group"] == 3):echo $this->session->userdata("LoggedUser")["FullName"];endif;?>" id="example-text-input" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <select required="" name="JenisFailID" class="custom-select col-12" id="inlineFormCustomSelect" oninvalid="this.setCustomValidity('Sila pilih dari senarai ini.')" oninput="setCustomValidity('')">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input name="TarikhPermohonan" class="form-control datepicker" type="text" value="" id="example-date-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-2 col-form-label">Tarikh Buka Fail</label>
                                    <div class="col-10">
                                        <input name="TarikhBukaFail" class="form-control datepicker" type="text" value="" id="example-date-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-2 col-form-label">Nama SO</label>
                                    <div class="col-10">
                                        <select required="" name="SOID" class="custom-select col-12" id="inlineFormCustomSelect" oninvalid="this.setCustomValidity('Sila pilih dari senarai ini.')" oninput="setCustomValidity('')">
                                            <option value="">Sila Pilih...</option>
